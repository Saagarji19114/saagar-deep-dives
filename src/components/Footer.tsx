...
const Footer = () => {
  ...
  {["Twitter/X", "Facebook", "LinkedIn", "YouTube"].map((s) => (
    <a 
      key={s} 
      href={
        s === "Twitter/X" 
          ? "https://x.com/sahjad_saagarji" 
          : s === "Facebook" 
            ? "https://www.facebook.com/share/1Gtt536AhM/" 
            : "#"
      } 
      target={(s === "Twitter/X" || s === "Facebook") ? "_blank" : undefined}
      rel={(s === "Twitter/X" || s === "Facebook") ? "noopener noreferrer" : undefined}
